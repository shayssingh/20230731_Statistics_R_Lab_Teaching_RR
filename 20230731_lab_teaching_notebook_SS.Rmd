...
#Chi Squared Test for Independence
  null hypothesis:iris species and petal length are independent
  alternative hypothesis: iris species and petal length are not independent
  
```{r}
chisq.test(iris$Species, iris$Petal.Length)
```
  conclusion: we reject the null hypothesis and conclude that specis and petal length are NOT independent variables in this dataset
